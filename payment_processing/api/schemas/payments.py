...
from payment_processing.domain import CurrencyCode, PaymentStatus
...
class CreatePaymentResponse(BaseModel):
    ...
    status: PaymentStatus = Field(title="Payment status", examples=[status for status in PaymentStatus])
